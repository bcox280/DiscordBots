 ...
 */
public class ParrotBot extends SimpleBot implements IListener<MessageReceivedEvent> {

    public ParrotBot(String token) {
        super(token);
    ...
    @Override
        ...
        try {
            ...
            new MessageBuilder(_client).withChannel(channel).withContent(message.getContent()).send();
            _client.changePlayingText("KYS");
